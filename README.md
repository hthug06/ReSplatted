...
**ReSplatted** is a Project created in rust. This project aim to be a stress test tool. But for now, you can just fetch the information of a Minecraft server
